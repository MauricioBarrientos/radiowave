...
const App = () => {
  ...
  const filteredStations = useMemo(() => {
    let filtered = stationsData.filter(
      (station) =>
  ...
  return (
    <div
      className={`app${isDarkMode ? ' dark-mode' : ''} flex flex-col items-center min-h-screen${isDarkMode ? '' : ' bg-gray-50'} p-4 md:p-8`}
    ...
    >
      ...
      <div
        className={`max-w-2xl mx-auto text-center${isDarkMode ? ' dark-mode' : ''}`}
